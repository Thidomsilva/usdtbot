...
export default function LoginForm() {
  ...
  const telegramQrTarget =
    "https://t.me/share/url?url=&text=Ol%C3%A1%20da%20ferramenta%20USDBot%20e%20gostaria%20de%20liberar%20meu%20acesso%20full";
  const telegramQrSrc =
    `https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent(telegramQrTarget)}`;
